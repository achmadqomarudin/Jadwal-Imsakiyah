package com.example.jadwalimsakiyah.activities
...
import com.example.jadwalimsakiyah.R
import com.example.jadwalimsakiyah.adapter.MainAdapter
import com.example.jadwalimsakiyah.model.ModelMain
import com.example.jadwalimsakiyah.service.GetAddressIntentService
...
class MainActivity : AppCompatActivity(), MainAdapter.onSelectData {
    ...
    private val location: String? = "Tulungagung"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lnLocationContainer!!.setOnClickListener {
            Toast.makeText(this@MainActivity, "Fitur masih dalam tahap pengembangan", Toast.LENGTH_SHORT).show()
        }
    ...
    private val textJSON: Unit
        get() {
            ...
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/timingsByCity?city=TULUNGAGUNG&country=Indonesia&method=5")
    ...
    private val dataJSON: Unit
        get() {
            ...
            progressDialog.setCanceledOnTouchOutside(false)
            progressDialog.show()
            AndroidNetworking.get("http://api.aladhan.com/v1/hijriCalendarByCity?city=TULUNGAGUNG&country=Indonesia&method=5&month=09&year=1441")
                    .setPriority(Priority.HIGH)
                    .build()
                    .getAsJSONObject(object : JSONObjectRequestListener {
                        override fun onResponse(response: JSONObject) {
